...
/*
 * package com.rakuten.CustomFinderMethod.swagger.config;
 * 
 ...
 * @Configuration
 * 
 * @EnableSwagger2 public class ConfigurerAdapter extends
 ...
 * "com.rakuten.CustomFinderMethod.controller")) .paths(PathSelectors.any())
 * .build(); }
 * 
